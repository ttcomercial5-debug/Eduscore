...
#=============================================================
    ...
    path("metodos-pagamento/criar/", views.criar_metodo_pagamento,name="criar_metodo_pagamento"),
    path("metodos-pagamento/<int:id>/editar/", views.editar_metodo_pagamento,name="editar_metodo_pagamento"),
    path("financeiro/gerar-mensalidades/", views.gerar_mensalidades, name="gerar_mensalidades"),
